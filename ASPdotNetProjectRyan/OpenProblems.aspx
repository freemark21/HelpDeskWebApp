...
<body>
    <form id="form1" runat="server">
        <div>
        <asp:GridView ID="gvOpenProb" runat="server" style="z-index: 1; left: 130px; top: 160px; position: absolute; height: 346px; width: 826px;" AutoGenerateSelectButton="True" OnRowCommand="gvOpenProb_RowCommand">
        </asp:GridView>
